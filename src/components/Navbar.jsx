    ...
    <nav>
      <div className="fixed bottom-8 right-4 sm:right-12 z-50">
        ...
        >
          ...
          <Link href="/">
            <button
              className={`absolute text-3xl sm:text-4xl bg-purple-500 py-1.5 sm:py-2 px-2.5 rounded-lgm border border-black drop-shadow-br bottom-0 right-48 sm:right-[210px] hover:-translate-y-1 transition-all duration-300 ease-in-out ${
                open ? "translate-y-0" : "translate-y-full"
              }`}
              onClick={toggleNavbar}
            >
